...
const long EditGame::ID_COMBOBOX14 = wxNewId();
const long EditGame::ID_STATICTEXT30 = wxNewId();
const long EditGame::ID_COMBOBOX15 = wxNewId();
const long EditGame::ID_STATICTEXT31 = wxNewId();
const long EditGame::ID_COMBOBOX16 = wxNewId();
...
EditGame::EditGame(wxWindow* parent, wxWindowID id)
{
    ...
    CheckListBox1 = new wxCheckListBox(Panel7, ID_CHECKLISTBOX1, wxDefaultPosition, wxSize(0,72), 0, 0, 0, wxDefaultValidator, _T("ID_CHECKLISTBOX1"));
    ...
    FlexGridSizer7->Add(CheckListBox1, 1, wxALL|wxEXPAND, 5);
    ...
    CheckListBox2 = new wxCheckListBox(Panel7, ID_CHECKLISTBOX2, wxDefaultPosition, wxSize(0,72), 0, 0, 0, wxDefaultValidator, _T("ID_CHECKLISTBOX2"));
    ...
    CheckListBox4 = new wxCheckListBox(Panel7, ID_CHECKLISTBOX4, wxDefaultPosition, wxSize(0,72), 0, 0, 0, wxDefaultValidator, _T("ID_CHECKLISTBOX4"));
    ...
    CheckListBox3 = new wxCheckListBox(Panel7, ID_CHECKLISTBOX3, wxDefaultPosition, wxSize(-1,72), 0, 0, 0, wxDefaultValidator, _T("ID_CHECKLISTBOX3"));
    ...
    FlexGridSizer8->Add(StaticText29, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    ComboBox14 = new wxComboBox(Panel8, ID_COMBOBOX14, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX14"));
    FlexGridSizer8->Add(ComboBox14, 1, wxALL|wxEXPAND, 5);
    ...
    ComboBox15 = new wxComboBox(Panel8, ID_COMBOBOX15, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX15"));
    FlexGridSizer8->Add(ComboBox15, 1, wxALL|wxEXPAND, 5);
    ...
    ComboBox16 = new wxComboBox(Panel8, ID_COMBOBOX16, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX16"));
    FlexGridSizer8->Add(ComboBox16, 1, wxALL|wxEXPAND, 5);
...
EditGame::SaveGameToDatabase()
{
    ...
    name.Replace("'", "''", true);
    const wxString path = ((LaunchConfig*) ActionListbook->GetPage(0))->FileCtrl->GetPath();
